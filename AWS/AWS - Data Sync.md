...
- **AWS storage services** (Amazon S3[^1], Amazon EFS, Amazon FSx, Amazon FSx for Windows File Server, Amazon FSx for Lustre, and even between AWS regions/accounts).
...
[^1]: Amazon S3 or Simple Storage Service is the main storage type of AWS [[AWS - S3]]
[^2]: Amazon EFS or Elastic File Storage is [[AWS - EFS Elastic File System]]  