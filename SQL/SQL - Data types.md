...
| TINYBLOB              | For Binary Large Objects (BLOBs) with a maximum length of 255 bytes.                        | -                      | -          |
...
| ENUM(val1, val2, ...) | A string object with only one value chosen from a list of possible values.                   | Up to 65535 values     | -          |
| SET(val1, val2, ...)  | A string object that can have 0 or more values chosen from a list of possible values.       | Up to 64 values        | -          |
