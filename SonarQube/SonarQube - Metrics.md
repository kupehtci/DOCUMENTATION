...
SonarQube measures the following **rules**: 
...
* **Quality gate**: defines the minimum set of rules and metrics that must be met in order to consider that the project has enough quality. 
